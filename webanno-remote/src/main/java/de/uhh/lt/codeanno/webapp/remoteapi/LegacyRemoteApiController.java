...
public class LegacyRemoteApiController
{
     ...
     * 'http://USERNAME:PASSWORD@localhost:8080/codeanno-webapp/api/projects'
     *
     * @param aName
     ...
     * 
     * curl -v -X DELETE
     * 'http://USERNAME:PASSOWRD@localhost:8080/codeanno-webapp/api/projects/{aProjectId}'
     * 
     * @param aProjectId
     ...
     * 
     * http://USERNAME:PASSWORD@localhost:8080/codeanno-webapp/api/projects/{aProjectId}/sourcedocs
     * 
     * @param aProjectId
     *            the project ID
     ...
     * Test when running in Eclipse: Open your browser, paste following URL with appropriate values:
     *
     * http://USERNAME:PASSWORD@localhost:8080/codeanno-webapp/api/projects/{aProjectId}/curationdoc/
