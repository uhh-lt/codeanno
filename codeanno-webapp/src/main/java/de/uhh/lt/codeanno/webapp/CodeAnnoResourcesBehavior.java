...
public class CodeAnnoResourcesBehavior
    extends Behavior
{
    private static final long serialVersionUID = 8847646938685436192L;

    private static final CodeAnnoResourcesBehavior INSTANCE = new CodeAnnoResourcesBehavior();

    @Override
    public void renderHead(Component aComponent, IHeaderResponse aResponse)
    {
        // Loading WebAnno / CodeAnno CSS here so it can override JQuery/Kendo CSS
    ...
    public static CodeAnnoResourcesBehavior get()
    {
        return INSTANCE;
    }
}
